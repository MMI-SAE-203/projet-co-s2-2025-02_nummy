import { c as createComponent, b as createAstro, m as maybeRenderHead, d as addAttribute, f as renderSlot, a as renderTemplate, r as renderComponent, g as defineScriptVars } from '../chunks/astro/server_D0p2hXWS.mjs';
import 'kleur/colors';
import { c as createSvgComponent, $ as $$Layout } from '../chunks/Layout_LuwkeAM4.mjs';
...
const imageAfr = new Proxy({"src":"/_astro/imageA.CWruwFFK.webp","width":672,"height":890,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/arthurwicky/Documents/projet-co-s2-2025-02_nummy/src/assets/img/imageA.webp";
							}
...
const imageAs = new Proxy({"src":"/_astro/imagech.sXflRwcD.webp","width":692,"height":868,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/arthurwicky/Documents/projet-co-s2-2025-02_nummy/src/assets/img/imagech.webp";
							}
...
const imageAm = new Proxy({"src":"/_astro/imageAM.BuTjlhhR.webp","width":692,"height":890,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/arthurwicky/Documents/projet-co-s2-2025-02_nummy/src/assets/img/imageAM.webp";
							}
...
const imageUE = new Proxy({"src":"/_astro/ImageUE.BBd0zOux.webp","width":692,"height":890,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/arthurwicky/Documents/projet-co-s2-2025-02_nummy/src/assets/img/ImageUE.webp";
							}
...
const imageT = new Proxy({"src":"/_astro/imageT.C5bA26ZB.webp","width":692,"height":892,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/arthurwicky/Documents/projet-co-s2-2025-02_nummy/src/assets/img/imageT.webp";
							}
...
const ImageVegetales = new Proxy({"src":"/_astro/foodBK.i3kk30Ob.webp","width":782,"height":795,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/arthurwicky/Documents/projet-co-s2-2025-02_nummy/src/assets/img/foodBK.webp";
							}
...
Soutenez notre projet et participez à son développement ! Chaque
            contribution compte pour nous aider à grandir !
...
Découvrez nos délicieuses recettes du monde entier ! Des plats
            authentiques pour voyager depuis votre cuisine.
</span>`, "image": ($$result3) => renderTemplate`${renderComponent($$result3, "Picture", $$Picture, { "slot": "image", "src": ImageRecette, "alt": "Recettes \xD1ummy", "class": "lg:w-100 lg:h-68 object-cover" })}`, "title": ($$result3) => renderTemplate`<span>Recettes Ñummy!</span>` })} </article> </div> </div> ` }), defineScriptVars({
    imagefille,
    imageAfr,
    imageAs,
    imageAm,
